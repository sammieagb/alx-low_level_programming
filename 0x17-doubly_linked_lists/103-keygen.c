...
/**
 * f4 - finds the bggest nuer
 *
 * @usrn: usernam
 * @len: length of sername
 * Return: the biggst number
 */
...
/**
 * f5 - multipes ach har of username
 *
 * @usrn: userame
 * @len: lengthf username
 * Return: multiped char
 */
